          ...
          <div className='painelSecundario'>
            ...
            <div className='planosDisponiveis'>
              ...
              <PlanoComponent 
                ...
                lista={'Limitado a 30 perfis/Missões ilimitadas/5 Painéis gerentes/Armazenamento de 4gb/Limitado a 7 salas/Regras personalizadas'}
                preco={'R$ 59.90'}  
              />
              <PlanoComponent 
                nome={'Premium Plus'} 
                descricao={'Para equipes grandes de até 60 pessoas'} 
                lista={'60 perfis/missões ilimitadas/10 painéis gerentes/Armazenamento 8gb/12 salas/Regras personalizadas'}
                preco={'R$ 115.90'}  
              />
            </div>
          </div>
